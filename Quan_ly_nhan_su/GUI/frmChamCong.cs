...
namespace Quan_ly_nhan_su.GUI
{
    public partial class frmChamCong : Form
    {
        ...
        private void LoadEmployeeContext(string maNV)
        {
            ...
            lblHoTenNhanVien.Text = string.IsNullOrWhiteSpace(nhanVien.TenNV) ? "Chưa cập nhật" : nhanVien.TenNV;
            lblSoDienThoai.Text = string.IsNullOrWhiteSpace(nhanVien.SoDienThoai) ? "Chưa cập nhật" : nhanVien.SoDienThoai;
            lblDiaChiNhanVien.Text = string.IsNullOrWhiteSpace(nhanVien.DiaChi) ? "Chưa cập nhật" : nhanVien.DiaChi;
